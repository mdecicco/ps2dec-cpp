...
namespace render {
    ...
    namespace utils {
        class SimpleDebugDraw : public IDebugDrawer, public ::decomp::IInputHandler {
            public:
                struct vertex {
                    public:
                        vec3f position;
                ...
                vulkan::GraphicsPipeline* getPipeline() const;
                ...
                virtual void onMouseDown(::decomp::MouseButton buttonIdx);
                virtual void onMouseUp(::decomp::MouseButton buttonIdx);
                virtual void onKeyDown(::decomp::KeyboardKey key);
                virtual void onKeyUp(::decomp::KeyboardKey key);
