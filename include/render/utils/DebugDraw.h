...
namespace render {
    namespace utils {
        ...
        class IDebugDrawable {
            public:
                virtual void debugDraw(const mat4f& transform = mat4f()) = 0;
        };
        ...
        class IDebugDrawer {
            public:
                ...
                virtual void line(const vec3f& a, const vec3f& b, const vec4f& color = {1.0f, 1.0f, 1.0f, 1.0f}) = 0;

                virtual void sphere(f32 radius, const mat4f& transform, const vec4f& color = {1.0f, 1.0f, 1.0f, 1.0f});
                virtual void sphere(f32 radius, const vec3f& center, const vec4f& color = {1.0f, 1.0f, 1.0f, 1.0f});
                virtual void triangle(
                    const vec3f& a, const vec3f& b, const vec3f& c, const vec4f& color = {1.0f, 1.0f, 1.0f, 1.0f}
                );
                virtual void aabb(
                    const vec3f& upper, const vec3f& lower, const vec4f& color = {1.0f, 1.0f, 1.0f, 1.0f}
                );
                virtual void transform(const mat4f& transform, f32 orthoLen);
                virtual void arc(
                    const vec3f& center,
                    const vec3f& normal,
                    const vec3f& axis,
        ...
        class DebugDraw {
            public:
                ...
                static void sphere(f32 radius, const mat4f& transform, const vec4f& color = {1.0f, 1.0f, 1.0f, 1.0f});
                ...
                static void transform(const mat4f& transform, f32 orthoLen);
                static void arc(
                    const vec3f& center,
                    const vec3f& normal,
                    const vec3f& axis,
