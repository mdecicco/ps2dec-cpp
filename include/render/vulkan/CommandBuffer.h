    ...
    namespace vulkan {
        ...
        class CommandBuffer {
            public:
                ...
                void bindVertexBuffer(VertexBuffer* vbo, u32 offset = 0);
                void bindVertexBuffer(Buffer* vbo, u32 offset = 0);
                void setViewport(f32 x, f32 y, f32 width, f32 height, f32 minZ, f32 maxZ);
                void setScissor(i32 x, i32 y, u32 width, u32 height);
                void updatePushConstants(
                    u32 offset, u32 size, const void* data, VkShaderStageFlags stages = VK_SHADER_STAGE_ALL
                );
