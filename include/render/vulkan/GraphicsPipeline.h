...
namespace render {
    namespace vulkan {
        ...
        class GraphicsPipeline : public Pipeline, public decomp::IWithLogging {
            public:
                GraphicsPipeline(
                ...
                void addStorageBuffer(u32 bindIndex, VkShaderStageFlagBits stages);
                void setPushConstantFormat(const core::DataFormat* fmt);
            ...
            protected:
                ...
                const core::DataFormat* m_pushConstantFormat;
                Array<uniform_block> m_uniformBlocks;
                Array<storage_buffer> m_storageBuffers;
