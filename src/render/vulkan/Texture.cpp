...
namespace render {
    namespace vulkan {
        ...
        bool Texture::init(
            ...
            if (!m_device->getPhysicalDevice()->getMemoryTypeIndex(
                    memReqs, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, &allocInfo.memoryTypeIndex
                )) {
        ...
        bool Texture::initSampler(VkFilter magFilter, VkFilter minFilter) {
            ...
            if (vkCreateSampler(m_device->get(), &si, m_device->getInstance()->getAllocator(), &m_sampler) !=
                VK_SUCCESS) {
        ...
        bool Texture::setLayout(CommandBuffer* cb, VkImageLayout layout) {
            ...
            if (layout == VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL) {
                ...
                if (m_format == VK_FORMAT_D16_UNORM_S8_UINT || m_format == VK_FORMAT_D24_UNORM_S8_UINT ||
            ...
            vkCmdPipelineBarrier(cb->get(), srcStage, dstStage, 0, 0, nullptr, 0, nullptr, 1, &b);
        ...
        void Texture::flushPixels(CommandBuffer* cb) {
            ...
            region.imageExtent                     = {m_dimensions.x, m_dimensions.y, m_depth};

            vkCmdCopyBufferToImage(
                cb->get(), m_stagingBuffer.get(), m_image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &region
            );
        }
    };
};